...
import { formatTurma } from "@/lib/format";
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="text-right">
            ...
            <div style={{ marginTop: "4px" }}>
              <span style={{
                color: copy === "original" ? "#1a3a6b" : "#94a3b8",
                fontWeight: 700, fontSize: "8.5px", textTransform: "uppercase", letterSpacing: "1.5px",
              }}>
                {copy === "original" ? "Original" : "Duplicado"}
              </span>
            </div>
          </div>
        </div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "10.5px" }}>
            <tbody>
              {[
                ...
                ["Classe",                  formatTurma(receipt.studentClass), `${testIdPrefix}-studentClass`],
